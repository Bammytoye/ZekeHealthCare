            ...
            <div className='flex items-center gap-4'>
                {token ? (
                    <div className='flex items-center gap-2 cursor-pointer group relative'>
                        ...
                        {/* Dropdown */}
                        <div className='absolute top-0 right-0 hidden pt-14 text-base font-medium text-gray-600 group-hover:block z-20'>
                    ...
                    <button
                        ...
                        className='bg-primary text-white px-4 py-3 rounded-full text-sm font-medium hidden md:block'
                    >
                        Create Account
                    </button>
                )}
